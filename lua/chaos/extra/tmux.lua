...
# chaOS colors for Tmux

set -g mode-style "fg=${pink},bg=${fg_gutter}"

set -g message-style "fg=${pink},bg=${fg_gutter}"
set -g message-command-style "fg=${pink},bg=${fg_gutter}"
...
setw -g window-status-current-format "#[fg=${bg_statusline},bg=${fg_gutter},nobold,nounderscore,noitalics]#[fg=${pink},bg=${fg_gutter},bold] #I  #W #F #[fg=${fg_gutter},bg=${bg_statusline},nobold,nounderscore,noitalics]"
